...
\begin{frame}
	...
	\begin{itemize}
	\item<1-> UAV\_visualization
	\item<2-> UAV\_physic\_engine
	\item<3-> UAV\_controller
	\item<4-> UAV\_drop\_physic
	\item<5-> UAV\_common
	\item<6-> UAV\_server
	\item<7-> UAV\_map\_generator
	\end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.33\textwidth}
            ...
            \begin{figure}
            \centering
            \uncover<8->{\includegraphics[height=0.2\textheight]{logos/lwjgl.png}}
            \end{figure}
        \end{column}
        \begin{column}{0.33\textwidth}
            \begin{figure}
            ...
            \begin{figure}
            \centering
            \uncover<9->{\includegraphics[height=0.2\textheight]{logos/python.png}}
            \end{figure}
        \end{column}
        \begin{column}{0.33\textwidth}
            \begin{figure}
            ...
            \begin{figure}
                \centering
                \uncover<10->{\includegraphics[height=0.2\textheight]{logos/osm.png}}
            \end{figure}
        \end{column}
    \end{columns}
\end{frame}
