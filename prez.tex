...
\begin{frame} % IF
    ...
    \begin{columns}
        ...
        \begin{column}{0.33\textwidth}
            ...
            \begin{figure}
                \centering
                \uncover<6->{\includegraphics[height=0.2\textheight]{logos/opengl.png}}
            \end{figure}
        \end{column}
        \begin{column}{0.33\textwidth}
            \begin{figure}
            ...
            \begin{figure}
                \centering
                \uncover<7->{\includegraphics[height=0.2\textheight]{logos/zmq.png}}
            \end{figure}
        \end{column}
    \end{columns}
\end{frame}
