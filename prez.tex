...
\begin{frame}%[allowframebreaks]
	...
	\begin{columns}
		...
		\begin{column}{0.33\textwidth}
			\begin{figure}
	   		 \centering
	      		 \uncover<7->{\includegraphics[width=0.35\textwidth]{logos/matlab.png}}
	    		\end{figure}
	    		\begin{figure}
	   		 \centering
	      		 \uncover<8->{\includegraphics[width=0.35\textwidth]{logos/JSBSim.png}}
	    		\end{figure}
			\begin{figure}
	   		 \centering
	      		 \uncover<9->{\includegraphics[width=0.35\textwidth]{logos/VBS.png}}
	    		\end{figure}
		\end{column}
	\end{columns}
\end{frame}
...
\subsection{Sterowanie statkiem powietrznym I}
