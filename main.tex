...
\textbf{UAV\_server} -- definicja kontenera Docker, odpowiedzialna zazbudowanie wszystkich modułów składających się na serwer, tj. wszystkie z wyłączeniem wizualizacji. Ze zbudowanych modułów budowany jest obraz Docker. Umożliwia to uruchomienie serwera na dowolnej maszynie wspierającej wirtualne kontenery Docker. \\
...
Ze względu na duży nakład obliczeniowy -- symulacja w czasie rzeczywistym z krokiem całkowania rzędu 1ms -- wybrany został język C++. Z uwagi na swoją wydajność i elastyczność stanowi on naturalny wybór w symulacjach. Dodatkowo wykorzystane zostały następujące biblioteki:
\begin{itemize}
	\item Eigen - 
	\item ZeroMQ -
	\item RapidXML - 
