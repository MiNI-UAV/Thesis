...
Oprogramowanie jest w głównej mierze przeznaczone dla producentów bezzałogowych statków powietrznych, umożliwiając testy BSP przed rzeczywistymi lotami próbnymi, co w rezultacie pozwoli na zminimalizowanie kosztów produkcji. Ma ono stanowić również narzędzie dla inżynierów zajmujących się projektowanie bezzałogowych statków powietrznych umożliwiając analizę zachowania dla wprowadzonych parametrów. Potencjalnymi klientami są również uczelnie z zamiarem wykorzystania oprogramowania w celach dydaktycznych oraz pasjonaci modelarstwa.\\

Dodatkowo system stanowi oprogramowanie rozrywkowe, jeśli zostanie wykorzystany w roli gry komputerowej.
...
\begin{itemize}[noitemsep,nolistsep]
	...
	\item może wybrać jedną z domyślnych konfiguracji BSP,
	...
	\item może zderzyć się z mapą, innym BSP lub pociskiem,
...
\begin{itemize}[noitemsep,nolistsep]
	...
	\item może dodać i zarządzać istniejącymi algorytmami całkowania.
\end{itemize}
\ \\
